# -*- coding: utf-8 -*-
"""
Created on Thu Sep 30 20:07:54 2021
...
#  (page 166). Write a method called increment_login_attempts() that increment
...
#  Exercise 9-1 (page 166) or Exercise 9-4 (page 171). Either version of 
...
#  displays theese flavors. Create an instance of IceCreamStand, and call this
#  method.
# =============================================================================
...
# that inherits from the User class you wrote in Exercise 9-3 (page 166) or 
# Exercise 9-5 (page 171). Add an attribute, privileges, that stores a list 
...
#         self.privileges = Privileges() # es un objeto este atribujo
...
#  call get_range() a second time after upgrading the battery. You should see
...
#  1 and the number of sides the die has. Make a 6-sided die and roll it
#  10 times.
...
# # print (winning_ticket) Obtengo la combinacion ganadora
